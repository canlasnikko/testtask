...
abstract class MemberTestCase extends WithDatabaseTestCase
{
    ...
    protected static $memberData = [
        'email_address' =>  'test3@flexisourceit.com.ph',
        'email_type'    =>  'html',
        'status'        =>  'subscribed',
        'language'      =>  'en',
        'location'      =>  [
    ...
    protected static $updateData = [
        'email_address' =>  'update3@flexisourceit.com.ph',
        'status'        =>  'pending'
    ];
    ...
    public function tearDown(): void
    {
        ...
        foreach ($this->createdListsId as $listId) {
